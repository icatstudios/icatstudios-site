...
export const metadata: Metadata = {
  ...
  description: "iCat Studios Privacy Policy",
};
...
export default function PrivacyPolicyPage() {
  return (
    <div className="mx-auto max-w-4xl px-6 py-16">
      ...
      <div className="prose-invert space-y-6 text-zinc-400 leading-relaxed">
        <p>
          iCat Studios built the apps listed below as a Free app:
        </p>
        <ul className="list-disc pl-6 space-y-1">
          <li>Potentials: FC26 Career Mode</li>
          <li>Score Hunter</li>
          <li>Player Potentials 21</li>
          <li>Player Potentials 20</li>
          <li>Player Potentials 19</li>
          <li>Player Potentials 18</li>
          <li>Fast and Blocky</li>
        </ul>

        <p>
          These SERVICES are provided by iCat Studios at no cost and is intended
          for use as is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at aforementioned apps
