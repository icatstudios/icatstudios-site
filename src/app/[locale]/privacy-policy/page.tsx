...
export default async function PrivacyPolicyIndex({ params }: Props) {
  const { locale } = await params;
  ...
  const apps = [
    {
      ...
      accent: "#14f174",
      external: true,
      // External target — middleware/redirect sends to scorehunter.app
      href: `/privacy-policy/score-hunter`,
    },
    {
      slug: "swapmap",
  ...
  return (
    <div className="relative">
      <LegalPageHeader
        ...
        title={t("title")}
        subtitle={tIndex("selectAppPrivacy")}
        icon={<ShieldIcon />}
      />
